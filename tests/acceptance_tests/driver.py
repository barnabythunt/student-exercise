...
class Driver:
    ...
    def _navigate_to_entries(self, register_name):
        self._navigate_to_registers()
        self._view_register(register_name)
    ...
    def update_existing_entry(self, name, new_name, register_name):
        self._navigate_to_entries(register_name)
    ...
    def confirm_entry_updated(self, old_name, new_name, register_name):
    ...
    def delete_existing_entry(self, entry_name, register_name):
        self._navigate_to_entries(register_name)
        self._view_entry(entry_name)
    ...
    def confirm_entry_deleted(self, name, register_name):
